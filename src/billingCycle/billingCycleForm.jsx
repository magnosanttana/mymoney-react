            ...
            <form role="form" onSubmit={handleSubmit}>
                <div className="box-body">
                    ...
                    <Field name='month' component={labelAndInput} type="number"
                        label='Mês' cols='12 4' placeholder='Informe o mês (númerico)' readOnly={readOnly}/>
                    <Field name='year' component={labelAndInput} type="number"
                        label='Ano' cols='12 4' placeholder='Informe o ano (AAAA)' readOnly={readOnly}/>
                        
                        <Summary credit={sumOfCredits} debt={sumOfDebts} />
                        <ItemList cols='12, 6' readOnly={readOnly} list={credits}
                            field='credits' legend='Créditos 2'
                        />
                        <ItemList cols='12, 6' readOnly={readOnly} list={debts} showStatus={true}
